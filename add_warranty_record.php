...
elseif ($purchase_date_parsed === null)
    $errors[] = "Purchase Date format invalid. Use YYYY-MM-DD or a valid date.";

if ($expiry_date === '')
    $errors[] = "Warranty Expiry Date is required.";
elseif ($expiry_date_parsed === null)
    $errors[] = "Warranty Expiry Date format invalid. Use YYYY-MM-DD or a valid date.";

if ($frequency === '')
    $errors[] = "Maintenance Frequency is required.";
